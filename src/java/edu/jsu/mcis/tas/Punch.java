...
public class Punch {
    ...
    public void setOriginaltimestamp(long millis){
        originalTimestamp = new GregorianCalendar();
        originalTimestamp.setTimeInMillis(millis);
    }

    public void setAdjustedtimestamp(GregorianCalendar adjustedTimeStamp) {
        this.adjustedTimestamp = adjustedTimeStamp;
    }
    public void setAdjustedtimestamp(long millis){
        adjustedTimestamp = new GregorianCalendar();
        adjustedTimestamp.setTimeInMillis(millis);
    }
